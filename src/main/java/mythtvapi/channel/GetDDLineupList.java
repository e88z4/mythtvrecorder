...
@XmlRootElement(name = "GetDDLineupList")
public class GetDDLineupList {

    @XmlElementRef(name = "Source", namespace = "http://mythtv.org", type = JAXBElement.class, required = false)
