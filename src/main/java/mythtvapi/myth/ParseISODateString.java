...
@XmlRootElement(name = "ParseISODateString")
public class ParseISODateString {

    @XmlElementRef(name = "DateTime", namespace = "http://mythtv.org", type = JAXBElement.class, required = false)
