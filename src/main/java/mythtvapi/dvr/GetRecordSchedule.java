...
@XmlRootElement(name = "GetRecordSchedule")
public class GetRecordSchedule {
    ...
    protected JAXBElement<Long> recordId;
    @XmlElementRef(name = "Template", namespace = "http://mythtv.org", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "MakeOverride", namespace = "http://mythtv.org", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> makeOverride;
     ...
     *     
     */
    public JAXBElement<Long> getRecordId() {
        return recordId;
    }
     ...
     *     
     */
    public void setRecordId(JAXBElement<Long> value) {
        this.recordId = value;
    }
     ...
     *     
     */
    public JAXBElement<Boolean> getMakeOverride() {
        return makeOverride;
    }
     ...
     *     
     */
    public void setMakeOverride(JAXBElement<Boolean> value) {
