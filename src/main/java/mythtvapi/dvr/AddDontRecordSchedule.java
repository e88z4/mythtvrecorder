 ...
 *         &lt;element name="NeverRecord" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AddDontRecordSchedule")
public class AddDontRecordSchedule {
    ...
    @XmlElementRef(name = "NeverRecord", namespace = "http://mythtv.org", type = JAXBElement.class, required = false)
    protected JAXBElement<Boolean> neverRecord;
    ...
    /**
     * Gets the value of the neverRecord property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<Boolean> getNeverRecord() {
        return neverRecord;
    }

    /**
     * Sets the value of the neverRecord property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link Boolean }{@code >}
     *     
     */
    public void setNeverRecord(JAXBElement<Boolean> value) {
        this.neverRecord = value;
    }
