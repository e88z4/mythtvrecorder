...
@XmlRootElement(name = "SetSavedBookmark")
public class SetSavedBookmark {
    ...
    @XmlElementRef(name = "Offset", namespace = "http://mythtv.org", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> offset;
     ...
     *     
     */
    public JAXBElement<Long> getOffset() {
        return offset;
    }
     ...
     *     
     */
    public void setOffset(JAXBElement<Long> value) {
        this.offset = value;
    }
