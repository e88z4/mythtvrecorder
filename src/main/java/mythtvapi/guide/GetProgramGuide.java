 ...
 *         &lt;element name="ChannelGroupId" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
...
@XmlRootElement(name = "GetProgramGuide")
public class GetProgramGuide {
    ...
    @XmlElementRef(name = "ChannelGroupId", namespace = "http://mythtv.org", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> channelGroupId;
     ...
     *     
     */
    public JAXBElement<Integer> getChannelGroupId() {
     ...
     *     
     */
    public void setChannelGroupId(JAXBElement<Integer> value) {
